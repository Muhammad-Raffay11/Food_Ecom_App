...
class MessageScreenAdmin extends StatefulWidget {
  var RecieverId ;
  var senderId;
   MessageScreenAdmin({super.key,this.RecieverId,this.senderId});

  @override
  State<MessageScreenAdmin> createState() => _MessageScreenAdminState();
}

class _MessageScreenAdminState extends State<MessageScreenAdmin> {
