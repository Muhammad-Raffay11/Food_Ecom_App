// ignore_for_file: avoid_function_literals_in_foreach_calls, avoid_print, unnecessary_brace_in_string_interps, prefer_typing_uninitialized_variables, non_constant_identifier_names
...
class AdminDishController extends GetxController {
  ...
  addDish() async {
    if (image == null) {
      ErrorMessege("error", "Please Select Dish Image");
    } else if (selectedDropdownKey == "") {
      ErrorMessege("error", "Please Enter Category");
    } else if (dishName.text.isEmpty) {
      ErrorMessege("error", "Please Enter DishName");
    } else if (dishPrice.text.isEmpty) {
      ErrorMessege("error", "Please Enter DishPrice");
    } else if (dropdownvalue == "All") {
      ErrorMessege("error", "Not add in this category");
    } else {
      ...
      ErrorMessege("Success", "New Dish Added!");
    }
  }
